...
opcode_entry opcode_table [512] = {
  /* 0x00 */	IDEXW(G2E,cmp,1), IDEX(G2E,cmp), IDEXW(G2E,cmp,1), IDEX(G2E,cmp),
  ...
  /* 0x10 */	IDEXW(G2E,adc,1), IDEX(G2E,adc), IDEXW(G2E,adc,1), IDEX(G2E,adc),
  ...
  /* 0x38 */	IDEXW(G2E,cmp,1), IDEX(G2E,cmp), IDEXW(G2E,cmp,1), IDEX(G2E,cmp),
  ...
  /* 0x6c */	EMPTY, EMPTY, EMPTY, IDEX(E2G,imul2),
